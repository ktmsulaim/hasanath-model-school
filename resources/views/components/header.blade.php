...
<nav x-cloak x-data="{ open: false, dropdown: false }" class="bg-gray-800 mb-4">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0 flex items-center text-white font-bold text-2xl">
                    <img class="h-8 w-auto mr-3" src="{{ asset('img/logo.png') }}" alt="Hasanath Girls Campus">
                    Hasanath Girls Campus
                </div>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="ml-3 relative">
                    <div>
                        <button @click.away="dropdown = false" @click="dropdown = !dropdown" type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
